...
export default function BlogEditPage({ params: { id } }: TProps) {
  ...
  const { data: blog } = useServerGet(
    async () => await getBlogsById(parseInt(id)),
  );
  ...
  }, [categories, blogData.categoryId]);
  ...
  const handleSave = async () => {
    ...
    const res = await EditBlog(parseInt(id), {
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-1">
          <h2 className="text-2xl font-bold">Edit Blog Settings</h2>
          <div>
